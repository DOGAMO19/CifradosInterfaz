...
export const Header = () => {
  return (
    <header className=' bg-[url(/public/img/headerImg.webp)] bg-no-repeat bg-cover bg-center flex justify-between items-center'>
        ...
        <Link to="/" className='text-white text-xl cursor-pointer hover:text-cyan-500'> Inicio </Link>
        <Link to="/base64" className=' text-white text-xl cursor-pointer hover:text-cyan-500'>Cifrar a base64</Link>
        <Link to="/aes" className=' text-white text-xl cursor-pointer hover:text-cyan-500'>Cifrado AES</Link>
